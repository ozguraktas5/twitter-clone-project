...
export default function More({close}) {
  ...
  return (
    <div>
      ...
      <div className="h-400px bg-[#2f3336] my-3">
        <button className="py-3 px-4 text-left transition-colors bg-black hover:bg-[#eff3f41a] w-full text-[15px] font-bold leading-[20px]">
        ...
        <button className="py-3 px-4 text-left transition-colors bg-black hover:bg-[#eff3f41a] w-full text-[15px] font-bold leading-[20px]">
          <div className="max-w-[228px]">@OzgurAktass hesabından çıkış yap</div>
        </button>
      </div>
    </div>
  );
