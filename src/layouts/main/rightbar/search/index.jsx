...
export default function Search() {
  ...
  return (
    ...
    >
      <label className="h-[2.688rem] rounded-full bg-[color:var(--background-third)] w-full group relative focus-within:bg-[color:var(--background-primary)] border border-transparent focus-within:border-[#1d9bf0]">
      ...
      {focus && (
        <div className="absolute top-full w-[350px] -translate-y-1 -left-px bg-[color:var(--background-primary)] shadow-box max-h-[calc(80vh-53px)] rounded-lg text-center min-h-[100px]">
