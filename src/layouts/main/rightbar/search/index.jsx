...
export default function Search() {
  ...
  return (
    ...
    >
      <label className="h-[43px] rounded-full bg-[color:var(--background-third)] w-full group relative focus-within:bg-black border border-transparent focus-within:border-[#1d9bf0]">
